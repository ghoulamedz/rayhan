        ...
        children: [
          Container(
            decoration: BoxDecoration(
              gradient: article.enAlerte
                  ? AppTheme.kCtaGradient
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    _StatCol(
                        label: 'Stock actuel',
                        value: article.stockActuel.toStringAsFixed(2)),
                    _StatCol(
                        label: 'Seuil minimum',
                        value: article.stockMinimum.toStringAsFixed(2)),
                    _StatCol(
                        label: 'Prix unitaire',
                        value: priceFmt.format(article.prixUnitaire)),
                  ],
                ),
                if (article.enAlerte) ...[
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setDlgState) => Padding(
          padding: EdgeInsets.fromLTRB(
              24, 12, 24, 32 + MediaQuery.of(ctx).viewInsets.bottom),
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor:
                      type == 'IN' ? AppTheme.kSuccessGreen : AppTheme.kErrorRed,
